...
color A
@ ECHO.
@ ECHO.      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ VANGUARD/EAC Cleaner ~~~~~~~~~~~~~~~~~~~~~~~~~~~
@ ECHO.
@ ECHO                                  This will Log you out so please write down your login details
@ ECHO.
@ ECHO               	! GAME WILL NOW VERIFY ITSELF UPON LOGGING IN, NO NEED TO RESTART PC ANYMORE EITHER !
@ ECHO.
@ ECHO.						           HAVING ERRORS IS NORMAL 
@ ECHO.
@ ECHO ------------------------------------------------------------------------------------------------------------------------
@ ECHO                  	             Ready... Press any key to Clean Vanguard
@ ECHO ------------------------------------------------------------------------------------------------------------------------
@ ECHO.
